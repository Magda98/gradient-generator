...
@Component({
  ...
  imports: [ColorPickerComponent, TrashIconComponent, CdkDropList, CdkDrag, DragIconComponent],
  template: `
  ...
  @for(item of colorsEntries(); track item[0]) {
    ...
    <button class="gg-button gg-button--icon gg-button--drag" (click)="removeColor(item[0])">
